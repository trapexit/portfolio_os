/* $Id: copyvram.c,v 1.2 1994/09/02 01:27:29 vertex Exp $ */
...
Err
CopyVRAMPages(Item ioreq, void *dest, void *src, ulong numpages, ulong mask)
{
IOInfo ioInfo;
uint32 pagesize;
    ...
    ioInfo.ioi_Send.iob_Len    = numpages*pagesize;
